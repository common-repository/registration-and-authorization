...
if(isset($_POST[$szPreTag.'iq_login'])) {
	include dirname( __FILE__ ).'/data_regist_do.php';
}
	...
	<li class="iq_authorization_li">
		<div class="iq_authorization_form_label_line">
			<div class="iq_authorization_form_dash_icon_block">
				<span class="icofont-brand-readernaut iq_authorization_form_dash_icon"></span>
			</div>
			<div>
				<div class="iq_authorization_form_label_txt">
					Желаемый логин
				</div>
				<input type="text" id="'.$szPreTag.'iq_login" name="'.$szPreTag.'iq_login" class="iq_authorization_login_input iq_authorization_login_input_default iq_authorization_full_width_b" placeholder="Логин" maxlength="64" value="" autocomplete="off">
			</div>
		</div>
	</li>
';
	...
	<li class="iq_authorization_li">
		<div class="iq_authorization_form_label_line">
			...
			<div>
				...
				<input type="text" id="'.$szPreTag.'iq_email" name="'.$szPreTag.'iq_email" class="iq_authorization_login_input iq_authorization_login_input_default iq_authorization_full_width_b" placeholder="email@example.com" maxlength="64" value="" autocomplete="off">
			</div>
		</div>
	</li>
';
	...
	<li class="iq_authorization_li">
		<div class="iq_authorization_form_label_line">
			...
			<div>
				...
				<input type="password" id="'.$szPreTag.'iq_repass" name="'.$szPreTag.'iq_repass" class="iq_authorization_login_input iq_authorization_login_input_default iq_authorization_full_width_b" placeholder="*******" maxlength="32" value="" autocomplete="off">
			</div>
		</div>
	</li>
';
...
$FormArr['buttons'] = '
	<li class="iq_authorization_li">
		<div class="iq_authorization_login_btn_block">
			...
			<a href="/'.$login_page.'" class="iq_authorization_login_btn iq_authorization_f1 iq_authorization_nowrap" onclick="LoginPage();return false;">
				Уже есть аккаунт
			</a>
		</div>
	</li>
...
include iq_authorization_TPL_DIR.'/front/iq_authorization_regist_index.php';
